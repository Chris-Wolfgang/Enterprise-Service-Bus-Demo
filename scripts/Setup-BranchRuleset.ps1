...
param(
    [Parameter()]
    [string]$Repository = "@Chris-Wolfgang/Enterprise-Service-Bus-Demo",
...
if ($Repository -eq "@Chris-Wolfgang/Enterprise-Service-Bus-Demo" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "@Chris-Wolfgang/Enterprise-Service-Bus-Demo") {
