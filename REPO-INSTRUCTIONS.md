...
2. Ensure any project name placeholders (for example, `Wolfgang.Demo.EnterpriseServiceBus`) have been replaced with your actual project name
...
```bash
bash ./scripts/Validate-DocsDeploy.ps1
```
...
2. Edit `docfx_project/docfx.json` and surrounding files to replace
   `Wolfgang.Demo.EnterpriseServiceBus`, `https://Chris-Wolfgang.github.io/Enterprise-Service-Bus-Demo/`, etc. with your project values.
